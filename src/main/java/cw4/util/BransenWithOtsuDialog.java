 ...
 * Date: 11/9/13
 */
public class BransenWithOtsuDialog extends CommonArgDialog {
    public BransenWithOtsuDialog(Picture picture, boolean modal, String myMessage) {
    ...
    public void actionPerformed(ActionEvent e) {
        if (getYesButton() == e.getSource()) {
            ...
            if (args.length == 2) {
                ...
                setVisible(false);
                PictureCustoms.showImageInNewWindow(conversionsCw4.brensenAndOtsuBinaryConversion(getPicture(), arg1, arg2));
            } else {
